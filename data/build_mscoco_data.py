...
def main(unused_argv):
    ...
    FLAGS.train_image_dir = r'./mscoco/train2014'
    FLAGS.val_image_dir = r'./mscoco/val2014'
    FLAGS.train_captions_file = r'./mscoco/annotations/captions_train2014.json'
    FLAGS.val_captions_file = r'./mscoco/annotations/captions_val2014.json'
    FLAGS.output_dir = r'./processed'
    FLAGS.word_counts_output_file = os.path.join(FLAGS.output_dir, 'word_counts.txt')
